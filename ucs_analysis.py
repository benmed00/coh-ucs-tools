...
Built on :mod:`parser` and :mod:`validator`; stdlib only.
"""
...
from parser import BOM_LE, UcsDocument, detect_encoding, parse_bytes, parse_file
from validator import _bad_characters
...
def _maybe_load_nsv_fingerprint() -> None:
    nsv = Path("downloads/RelicCOH.English.NSV.ucs")
    if nsv.exists():
