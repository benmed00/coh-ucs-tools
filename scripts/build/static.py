...
Copies ``src/coh_ucs_tools/web/static/`` into ``dist/`` with ``index.html`` at the root,
relative asset paths, and a production ``js/config.js`` pointing at the Fly.io API.

Usage::

    python scripts/build/static.py
    python scripts/build/static.py --api-base https://coh-ucs-tools.fly.dev --out build/dist
...
STATIC_SRC = ROOT / "src" / "coh_ucs_tools" / "web" / "static"
...
def _write_config_js(dest: Path, api_base: str, site_url: str, base_path: str) -> None:
    ...
    dest.write_text(
        "// Generated by scripts/build/static.py — do not edit in dist/.\n"
...
def _write_robots(dest: Path, site_url: str) -> None:
    from coh_ucs_tools.web.seo import robots_txt
...
def _base_path_for_site(site_url: str) -> str:
    from coh_ucs_tools.web.seo import GITHUB_PAGES_BASE_PATH
...
def build_static(out_dir: Path, api_base: str, site_url: str) -> None:
    ...
    from coh_ucs_tools.web.seo import SPA_ROUTES
