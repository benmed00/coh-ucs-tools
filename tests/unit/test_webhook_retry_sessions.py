...
from coh_ucs_tools.web.auth import create_session_token, peek_session_token, verify_session_token
...
class WebhookRetryTests(unittest.TestCase):
    def test_fire_webhooks_retries_then_dead_letters(self) -> None:
        ...
        from coh_ucs_tools.web.services import fire_webhooks
        ...
        with patch("coh_ucs_tools.web.services._post_webhook", return_value=(False, None, "down")):
            with patch("coh_ucs_tools.web.services.time.sleep"):
    ...
    def test_retry_dead_letters_endpoint(self) -> None:
        from coh_ucs_tools.web import db as db_mod
        from coh_ucs_tools.web.db import get_db
        from coh_ucs_tools.web.services import _log_webhook_delivery, retry_dead_letter_webhooks
        ...
        with patch("coh_ucs_tools.web.services._post_webhook", return_value=(True, 200, "")):
