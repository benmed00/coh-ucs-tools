...
Fonts live under `src/coh_ucs_tools/web/static/fonts/` with `@font-face` rules in
`src/coh_ucs_tools/web/static/css/fonts.css`. Regenerate after a Google Fonts update:
