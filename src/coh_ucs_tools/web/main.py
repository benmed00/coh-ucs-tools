...
``/redoc``) and the static single-page frontend from ``src/coh_ucs_tools/web/static/``.
"""
...
from coh_ucs_tools.config.paths import default_uploads_dir, ensure_storage_layout
...
async def lifespan(app: FastAPI):
    ...
    store = FileStore(default_uploads_dir())
