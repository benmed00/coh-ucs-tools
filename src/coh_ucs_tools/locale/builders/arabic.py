...
from coh_ucs_tools.config.paths import CACHE_DIR, REPORTS_DIR
...
from coh_ucs_tools.tools.translate import MtClient, translate_text
...
CACHE_PATH = CACHE_DIR / "mt_ar_cache.json"
REPORT_DIR = REPORTS_DIR / "arabic"
