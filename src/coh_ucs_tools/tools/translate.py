...
from coh_ucs_tools.config.paths import CACHE_DIR, DOWNLOADS_DIR, REPORTS_DIR
from coh_ucs_tools.core.parser import parse_file

logger = logging.getLogger(__name__)

ENDPOINT = "https://translate.googleapis.com/translate_a/single"
CACHE_PATH = CACHE_DIR / "mt_cache.json"
REPORT_TSV = REPORTS_DIR / "translation_comparison.tsv"
REPORT_JSON = REPORTS_DIR / "translation_summary.json"
...
DEFAULT_REFERENCE = DOWNLOADS_DIR / "RelicCOH.English.NSV.ucs"
