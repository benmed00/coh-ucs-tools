...
from coh_ucs_tools.core.merge import PLACEHOLDER, merge_and_write
from coh_ucs_tools.core.parser import UcsDocument, parse_file
from coh_ucs_tools.analysis.stats import REPORT_DIR, Comparison, compress_ranges, generate_report
from coh_ucs_tools.core.validator import validate
from coh_ucs_tools.tools.verification import print_checklist_report, run_checklist, run_checklist_file
from coh_ucs_tools.tools.duplicate_probe import probe_instructions, write_duplicate_probe
from coh_ucs_tools.tools.depot import download_depot_locale, run_locale_build
from coh_ucs_tools.locale.coverage import build_coverage_table, write_coverage_report
from coh_ucs_tools.io.sga import extract_all_locale_ucs, inject_ucs_into_sga, pack_sga, scan_install_locale_archives
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    sub.add_parser("compare", help="compare the files and write storage/reports/")
